...
template at <https://github.com/zhaozhao626/mdbook-site>
...
```
$ git remote add origin git@github.com:zhaozhao626/mdbook-site.git # change to your github repo
$ git branch -M main
...
View your site at <https://zhaozhao626.github.io/mdbook-site/>.
